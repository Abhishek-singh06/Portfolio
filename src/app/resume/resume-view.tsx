...
// Drop the compiled PDF here: frontend/public/Abhishek_Kumar_Singh_Resume.pdf
const RESUME_PATH = "/Abhishek_Kumar_Singh_Resume.pdf";
      ...
      <div className="mx-auto flex w-full max-w-4xl flex-1 items-center justify-center px-2 pb-6 md:items-start md:px-4 md:pb-24">
        ...
        >
          <ResumeDoodle
            ...
            title="Abhishek Kumar Singh — Résumé"
          />
        </motion.div>
      </div>
    </div>
